package efub.community.communityAssignment.member.domain;

import efub.community.communityAssignment.global.BaseTimeEntity;
...
import static efub.community.communityAssignment.member.domain.MemberStatus.REGISTERED;
...
public class Member extends BaseTimeEntity {
    ...
    public Member(String email,String password,String nickname,Integer studentId,
                  String university){
        this.email=email;
