...
import com.efub.community.global.exception.UnAuthorizedException;
import com.efub.community.security.service.UserDetailsServcieImpl;
...
public class JwtProvider {
    ...
    public String getAccessToken(String authorizationHeader) {
        ...
        if(authorizationHeader == null || authorizationHeader.equals("null")){
            throw new BadRequestException("빈 토큰입니다.");
        }
